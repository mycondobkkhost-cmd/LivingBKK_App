# Phase 20: ทะเบียนทรัพย์รวม (RXT) — ไม่ซ้ำหน้าลูกค้า + หลายเอเจ้นท์หลังบ้าน

> **รหัสปัจจุบัน:** `RXT-YYYY-######` (RealXtate) · เดิม `PPTR-` (PROPPITER) — migration `20260609190000`
...
| หัวข้อ | รายละเอียด |
|--------|------------|
| รหัสทรัพย์กลาง | `RXT-2026-000001` ต่อหน่วยทรัพย์ (RealXtate · จับคู่จากโครงการ+ห้อง+ชั้น+ตร.ม.+ประเภทธุรกรรม) |
