-- Fix production listing browse/posting flows.
...
COMMENT ON VIEW public.listings_public IS
  'หน้าบ้าน RealXtate — ใช้เฉพาะประกาศ published/display clean และไม่พึ่ง inventory_members/is_public ที่ยังไม่มี';
...
CREATE POLICY listings_insert ON public.listings
  ...
  WITH CHECK (
    ...
    OR (
      ...
      AND listed_by_role IN ('owner'::public.listed_by_role, 'agent'::public.listed_by_role)
    )
  );
