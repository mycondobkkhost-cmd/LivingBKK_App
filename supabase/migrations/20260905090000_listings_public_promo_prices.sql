-- โปรเช่า (price_internal) และโปรขาย ต้องอยู่ใน listings_public
-- ไม่เช่นนั้นแอปอ่านได้ แต่บอร์ด/แผนที่/รายละเอียดไม่มีราคาขีดฆ่า
...
COMMENT ON VIEW public.listings_public IS
  'Seeker-facing listing data including promo prices; never exposes unit_number, exact_floor, location_exact';
